import { Gauge, ClipboardList, BarChart3, Activity, MessageSquare, FolderKanban, Users, Network, DollarSign, Shield, Target, Heart, Ticket, GitBranch, Radio, Server, Sparkles, Settings2, Swords, Workflow, FileText, Building2 } from "lucide-react";
